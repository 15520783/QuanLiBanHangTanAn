...
public class FormDuyetHoaDonLe extends javax.swing.JFrame {
    ...
    public FormDuyetHoaDonLe(String SoHDL, Date NgayLap, String TongTien, ObjKhachHang ObjKH, ArrayList<ObjChiTietHDL> listGioHang) {
        initComponents();
        LoadForm();
    ...
    public FormDuyetHoaDonLe(ObjHoaDonLe objectHDL, ObjKhachHang ObjKH, ArrayList<ObjChiTietHDL> listGioHang, String TongTien) {
        ...
        jtxtSDT.setText(ObjKH.getSDT());
        jtxtDiaChi.setText(ObjKH.getDiaChi());
        jDateNgayLap.setDate(objectHDL.getNgayDat());
        jtxtTongTien.setText(TongTien);
        jtxtSoTienNo.setText(String.format("%,d", objectHDL.getSoNoHienTai()));
        jtxtSoTienCanThanhToan.setText(String.format("%,d", Integer.parseInt(TongTien.replace(",", "")) + objectHDL.getSoNoHienTai()));
        jtxtSoTienDaThanhToan.setText(String.format("%,d", objectHDL.getSoTienDaThanhToan()));
        DefaultTableModel Model = (DefaultTableModel) jTbCTHDS.getModel();
    ...
    private void initComponents() {
        ...
        jPanel2.add(jtxtSoHDL, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 55, 306, -1));
    ...
    private void jBtnBackMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBtnBackMouseClicked
        ...
        if (!ChinhSua) {
            ...
            if (!LuuThanhCong) {
                FormLapHoaDonLe FrmLapHDL = new FormLapHoaDonLe(ObjHDL, ListCTHDL, jDateNgayLap.getDate());
