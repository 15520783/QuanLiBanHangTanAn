...
public class FormLapHoaDonSi extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jtxtSoHDS, new org.netbeans.lib.awtextra.AbsoluteConstraints(106, 51, 207, -1));
    ...
    public void ReloadForm() {
        ...
        jtxtSoHDS.setText(CtrlHDL.LaySoHDL());
        jDateNgayLap.setDate(new Date());
        DefaultTableModel model;
        ...
        if (inputdialog != null) {
            try {
                ...
                if (!inputdialog.equals("0")) {
                    ObjChiTietHDS itemGioHang = new ObjChiTietHDS(listSP.get(modelRow).getMaSP(), listSP.get(modelRow).getTenSP(), listSP.get(modelRow).getDVT(), SL, listSP.get(modelRow).getGiaSi());
                    try {
